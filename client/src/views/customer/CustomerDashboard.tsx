      ...
      >
        ...
        <motion.img
          ...
          style={{
            ...
            maskImage: 'linear-gradient(to right, transparent 0%, rgba(0,0,0,0.6) 14%, #000 40%, #000 88%, transparent 100%)',
            WebkitMaskImage: 'linear-gradient(to right, transparent 0%, rgba(0,0,0,0.6) 14%, #000 40%, #000 88%, transparent 100%)',
          }}
        />
        <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: 'clamp(32px, 4vw, 52px)', color: '#fff', maxWidth: 560 }}>
          ...
          <h1 className="bb-display" style={{ color: '#fff', fontSize: 'clamp(2.4rem, 5vw, 4rem)', lineHeight: 0.95, textShadow: '0 2px 24px rgba(140,60,200,0.4)' }}>
            Your{' '}
