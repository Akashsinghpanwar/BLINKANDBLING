...
export const METAL_SPECS: Record<MetalType, MetalSpec> = {
  ...
  "22k-yellow":      { name: "22k Yellow Gold", color: "#F0C020", metalness: 1.0, roughness: 0.10, density: 17.7,  pricePerGram: 72   },
  ...
  "palladium":       { name: "Palladium",       color: "#D5D5D3", metalness: 1.0, roughness: 0.09, density: 12.02, pricePerGram: 50   },
};
